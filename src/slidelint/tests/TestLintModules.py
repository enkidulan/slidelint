...
class TestLinterRunner(unittest.TestCase):
    def setUp(self):
        self.kwargs = {
            ...
            'config_file': os.path.join(here, 'files', 'configurations', 'test_models.cfg'),
    ...
    def test_get_messages_info_all(self):
        ...
        compare(results,
            [dict(id='W1010', msg_name='warning-W1010', msg='warning message with id W1010',
                  page='', help='full help message'),
             dict(id='C1011', msg_name='critical-C1011', msg='warning message with id C1011',
                  page='', help='full help message'),
             dict(id='W1020', msg_name='warning-W1020', msg='warning message with id W1020',
                  page='', help='full help message'),
             dict(id='C1021', msg_name='critical-C1021', msg='warning message with id C1021',
                  page='', help='full help message'),
             dict(id='W2010', msg_name='warning-W2010', msg='warning message with id W2010',
                  page='', help='full help message'),
             dict(id='C2011', msg_name='critical-C2011', msg='warning message with id C2011',
                  page='', help='full help message')])
    ...
    def test_get_messages_info_list_ids(self):
        ...
        compare(results,
            [dict(id='W1010', msg_name='warning-W1010',
                  msg='warning message with id W1010', page='', help='full help message'),
             dict(id='W2010', msg_name='warning-W2010',
                  msg='warning message with id W2010', page='', help='full help message'),
             dict(id='C2011', msg_name='critical-C2011',
                  msg='warning message with id C2011', page='', help='full help message')])
    ...
    def test_get_messages_info_text_output(self):
        ...
        with OutputCapture() as output:
            results = lint(**self.kwargs)
        output.compare("********************** Slide Deck /path/to/presentation.pdf\n"
        ...
        compare(results,
            [dict(id='C2011', msg_name='critical-C2011',
             ...
             dict(id='C1011', msg_name='critical-C1011',
                  msg='warning message with id C1011 arg1 is "10"; arg2 is "20"', page='2')])
