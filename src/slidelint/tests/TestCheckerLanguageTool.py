        ...
        compare(rez,
                [{'help': 'It would be a honour.',
                 ...
                 {'help': 'It would be a honour.',
                  ...
                  'page': '1'},
                 {'help': 'It was only shown on ITV and not B.B.C.',
                  'id': 'C1010',
                  'msg': 'misspelling - Possible spelling mistake found',
                  'msg_name': 'language-tool-MORFOLOGIK_RULE_EN_US',
                  'page': '1'},
                 {'help': "...han 20 people left they're coats in the cloakroomI know alot about precious stones.",
                  'id': 'C1010',
                  'msg': 'misspelling - Possible spelling mistake found',
                  'msg_name': 'language-tool-MORFOLOGIK_RULE_EN_US',
                  'page': '3'},
                 {'help': "...ft they're coats in the cloakroomI know alot about precious stones.",
                  'id': 'C1010',
                  'msg': 'misspelling - Possible spelling mistake found',
                  'msg_name': 'language-tool-MORFOLOGIK_RULE_EN_US',
                  'page': '3'}])
