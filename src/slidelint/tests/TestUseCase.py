...
#         self.dir = '/home/enki/projects/slidelint'
...
# $ bin/slidelint -i src/slidelint/tests/files/pdfs/presentation3.pdf
...
# bin/slidelint -f parseable src/slidelint/tests/files/pdfs/presentation3.pdf
# No config file found, using default configuration
# ********************** Slide Deck src/slidelint/tests/files/pdfs/presentation3.pdf
...
# bin/slidelint -i -f colorised -d C3000,ContentQuality,edges_danger_zone -e language_tool_checker  src/slidelint/tests/files/pdfs/presentation3.pdf
# No config file found, using default configuration
