    ...
    def test_info_option(self):
        with api.lcd(self.dir):
            ...
            testfixtures.compare(rez,
                 ...
                 'C3000:Slide 9: Low text color to background contrast. (text-readability)\n'
    ...
    def test_output_format(self):
        with api.lcd(self.dir):
            ...
            testfixtures.compare(rez,
                 ...
                 'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 9: [C3000(text-readability), ] Low text color to background contrast.\n'
