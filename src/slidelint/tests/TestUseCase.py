...
class TestAcceptance(unittest.TestCase):
    ...
    def setUp(self):
        self.target_file = os.path.join(
            here, 'files', 'pdfs', 'presentation3.pdf')
        self.dir = os.getcwd()
    ...
    def test_info_option(self):
        with api.lcd(self.dir):
            rez = run("bin/slidelint -i src/slidelint/tests/files/pdfs"
                      "/presentation3.pdf")
            testfixtures.compare(
                rez,
                'No config file found, using default configuration\n'
                '********************** Slide Deck src/slidelint/tests'
                '/files/pdfs/presentation3.pdf\n'
    ...
    def test_output_format(self):
        with api.lcd(self.dir):
            rez = run("bin/slidelint -f parseable src/slidelint/"
                      "tests/files/pdfs/presentation3.pdf")
            testfixtures.compare(
                rez,
                'No config file found, using default configuration\n'
                '********************** Slide Deck src/slidelint/tests/'
                'files/pdfs/presentation3.pdf\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 12: '
                '[C1003(too-close-to-edges), ] Too close to edges\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 9: '
                '[C3000(text-readability), ] Low text color to background '
                'contrast.\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 11: '
                '[C3000(text-readability), ] Low text color to background '
                'contrast.\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 1: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 2: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 3: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 4: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 5: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 6: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 7: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 8: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 9: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 10: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 11: '
                '[C1002(font-to-small), ] Font is to small\n'
                'src/slidelint/tests/files/pdfs/presentation3.pdf:Slide 12: '
    ...
    def test_enablind_disabling(self):
        with api.lcd(self.dir):
            rez = run("bin/slidelint -i -f colorised -d C1002,ContentQuality"
                      ...
                      "slidelint/tests/files/pdfs/presentation3.pdf")
            testfixtures.compare(
                rez,
                'No config file found, using default configuration\n'
    ...
    def test_file_output_file(self):
        with api.lcd(self.dir):
            rez = run("bin/slidelint -f html --files-output src/slidelint/"
                      "tests/files/pdfs/presentation.pdf")
            testfixtures.compare(
                rez,
                "No config file found, using default configuration")
            ...
            testfixtures.compare(
                ...
                "<html>\n"
                "<body>\n"
                "<h1>Slide Deck src/slidelint/tests/files/pdfs/"
                "presentation.pdf</h1>\n"
    ...
    def test_custom_config_file(self):
        with api.lcd(self.dir):
            rez = run("bin/slidelint --config=src/slidelint/tests/files/"
                      "my_config.cfg src/slidelint/tests/files/pdfs"
                      "/presentation3.pdf")
            testfixtures.compare(
                rez,
                "********************** Slide Deck src/slidelint/tests/"
